...
<body id="grad1">
    ...
    <div id="wrapper" ">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Document Submissions</h1>
					<div class="container home">
		<a href="view_schedule.php"><i class="fa fa-sign-out fa-fw"></i> Back</a><br>
	...
	mysqli_select_db($con,'login'); 
			    ...
			    $no=1;
				$result = mysqli_query($con,"SELECT * FROM presentation where fid='".$_SESSION['id']."' ");
			  ...
			  ?>
                <tr>
				  ...
				  <td><a href="uploads/<?php echo $data->file?>" target="new"><?php echo $data->file?></a></td>
