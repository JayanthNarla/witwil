...
?>
	...
	mysqli_select_db($con,'login'); 
			    ...
			    $no=1;
				$result = mysqli_query($con,"SELECT * FROM presentation WHERE date BETWEEN '$sdate' AND '$edate' and fid LIKE '%EEE%';");
...
<?php
$list=mysqli_query($connect,"select distinct(subject) from ttinfo where year ='".$_SESSION['year']."' and sec='".$_SESSION['sec']. "'  and dept='EEE'");
while($row_list = mysqli_fetch_assoc($list)){
?>
		  ...
		  if(isset($_POST['display']))
{
	...
	mysqli_select_db($con,'login'); 
			    ...
			    $no=1;
			    $r_fid= mysqli_query($con,"SELECT faculty_id FROM ttinfo WHERE subject='".$_POST['new']."' and year= '".$_SESSION['year']."' and sec='".$_SESSION['sec']."' and dept='EEE' limit 1;");
