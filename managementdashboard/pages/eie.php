...
<div id="wrapper" >
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">EIE Reports</h1>
                </div>
...
?>
	...
	mysqli_select_db($con,'login'); 
			    ...
			    $no=1;
				$result = mysqli_query($con,"SELECT * FROM presentation WHERE date BETWEEN '$sdate' AND '$edate' and fid LIKE '%EIE%';");
...
$list=mysqli_query($connect,"select distinct(year) from ttinfo where dept ='EIE';");
...
$list1=mysqli_query($connect,"select distinct(sec) from ttinfo where dept ='EIE' ;");
...
<?php
$list=mysqli_query($connect,"select distinct(subject) from ttinfo where year ='".$_SESSION['year']."' and sec='".$_SESSION['sec']. "'  and dept='EIE'");
while($row_list = mysqli_fetch_assoc($list)){
?>
		  ...
		  if(isset($_POST['display']))
{
	...
	mysqli_select_db($con,'login'); 
			    ...
			    $no=1;
			    $r_fid= mysqli_query($con,"SELECT faculty_id FROM ttinfo WHERE subject='".$_POST['new']."' and year= '".$_SESSION['year']."' and sec='".$_SESSION['sec']."' and dept='EIE' limit 1;");
