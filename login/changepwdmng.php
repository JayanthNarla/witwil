...
Management id :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" name="mgmtid" span id="currentPassword" required>
<br>
Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
if (count($_POST) > 0) {
    $result = mysqli_query($conn,  "SELECT * from managementdb WHERE id='" . $_POST["mgmtid"]. "'");
    $row = mysqli_fetch_array($result);
	
	
    
    if ( $_POST["newPassword"] == $_POST["confirmPassword"] && $_POST["email"] == $row["email"]) {
        mysqli_query($conn, "UPDATE managementdb set password='" . $_POST["newPassword"] . "' WHERE id='" . $_POST["mgmtid"]. "'");
        
		  echo "<script>alert('password changed');window.location.href='http://10.45.8.185/witnwil/login/managementlogin.php';  </script>"; 
