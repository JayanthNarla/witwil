<?php
include('managementloginverify.php') ;
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/3.jpg');">
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="managementlogin.php">
					...
					<a href="changepwdmng.php" class="txt2 bo1 m-l-5 p-t-31">
							<h5><font color="black">Forgot Password ?</font></h5>
						</a>
