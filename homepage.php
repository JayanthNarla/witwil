	...
	<main class="main-content">
		<div class="elementor elementor-5">
			...
			<div class="row h-full align-items-center">
				...
				<h1>SIGN IN AS</h1>
<br/>
					<a href="login/adminlogin.php" class="btn-google m-b-26">
						<img src="images/icons/admin.png" alt="GOOGLE">
						
						Admin
					</a>

					<a href="login/facultylogin.php" class="btn-google m-b-20">
						<img src="images/icons/icon-google.png" alt="GOOGLE">
						Faculty
					</a>
					
					<a href="login/studentlogin.php" class="btn-google m-b-20">
						<img src="images/icons/stu.png" alt="GOOGLE">
						Student
					</a>
					<a href="login/managementlogin.php" class="btn-google m-b-20">
						<img src="images/icons/content.png" alt="GOOGLE">
						Reports
					</a>
